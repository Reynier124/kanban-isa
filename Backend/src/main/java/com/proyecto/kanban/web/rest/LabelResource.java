...
import com.proyecto.kanban.repository.LabelRepository;
import com.proyecto.kanban.service.LabelService;
...
/**
 * REST controller for managing {@link com.proyecto.kanban.domain.Label}.
 */
@RestController
...
public class LabelResource {
    ...
    public ResponseEntity<LabelDTO> createLabel(@Valid @RequestBody LabelDTO labelDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/labels/" + labelDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, labelDTO.getId().toString()))
            .body(labelDTO);
    }
    ...
    public ResponseEntity<LabelDTO> partialUpdateLabel(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, labelDTO.getId().toString())
        );
    }
